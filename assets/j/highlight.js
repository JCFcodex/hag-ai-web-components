var hljs = (function () {
    ...
    return (
      ...
      (function t(r, s) {
        ...
        return (
          ...
          (l = l || /\w+/),
          r.keywords && (r.keywords = j(r.keywords, e.case_insensitive)),
    ...
    ne = (t) => {
      ...
      function f(e, t, i, r) {
        ...
        function b(e, n) {
          return (
            e.scope &&
              ...
              A.openNode(N.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (g(
                    S,
        ...
        let S = '',
          ...
          D = !1;
        try {
          if (N.__emitTokens) N.__emitTokens(t, A);
          else {
  ...
  const ae = (e) => ({
    ...
    le = [
      ...
      .sort()
      .reverse(),
    ce = se.concat(oe).sort().reverse();
  var de = '[0-9](_*[0-9])*',
    ge = `\\.(${de})`,
    ue = '[0-9a-fA-F](_*[0-9a-fA-F])*',
    be = {
      className: 'number',
      variants: [
        {
  ...
  function me(e, n, t) {
    return -1 === t ? '' : e.replace(n, (a) => me(e, n, t - 1));
  }
  ...
  var Pe = Object.freeze({
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        g = [
          ...
          { className: 'built_in', match: b(/\b/, m(...Re), /(?=\()/) },
        ],
        u = { match: /->/, relevance: 0 },
        p = [
          u,
        ...
        R = {
          ...
          contains: [
            ...
            { className: 'type', match: ze, relevance: 0 },
            { match: /[?!]+/, relevance: 0 },
            {
              match: /\.\.\./,
              relevance: 0,
            },
            { match: b(/\s+&\s+/, d(ze)), relevance: 0 },
          ],
        },
        D = {
          begin: /</,
      ...
      const I = {
        ...
        $ = {
          match: [/(func|macro)/, /\s+/, m(S.match, Fe, Le)],
          className: { 1: 'keyword', 3: 'title.function' },
          contains: [L, B, n],
          illegal: [/\[/, /%/],
        },
        ...
        U = {
          ...
          contains: [
            ...
            ...c,
            {
              ...
              keywords: l,
              contains: [{ scope: 'title.class.inherited', match: ze }, ...c],
              relevance: 0,
            },
          ],
        };
    ...
    grmr_typescript: (e) => {
      ...
      return (
        n.exports.PARAMS_CONTAINS.push([n.exports.CLASS_REFERENCE, c]),
 ...
 * Library URL: https://highlightjs.org/
 * Version: 11.10.0
