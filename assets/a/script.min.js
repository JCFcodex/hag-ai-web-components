...
window.addEventListener('load', async () => {
  ...
  const fetchCurrentVersion = async () => {
    try {
      const response = await fetch('https://hag-ai-prochat.onrender.com/version', {
        method: 'GET',
        credentials: 'include',
      });
      if (!response.ok)
    ...
    try {
      ...
      while (!isScrollable(messagesContainer)) {
        const response = await fetch(
          `https://hag-ai-prochat.onrender.com/messages?offset=${offset}&limit=${limit}`,
          {
            method: 'GET',
            credentials: 'include',
          }
  ...
  const loadMoreMessages = async () => {
    ...
    try {
      const response = await fetch(`https://hag-ai-prochat.onrender.com/messages?offset=${offset}&limit=2`, {
        method: 'GET',
        credentials: 'include',
      });
      const messagesData = await response.json();
  ...
  const deleteMessages = async (e) => {
    ...
    try {
      ...
      if (isConfirmed) {
        ...
        showLoadingScreen();
        const response = await fetch('https://hag-ai-prochat.onrender.com/messages', {
          method: 'DELETE',
          credentials: 'include',
        });
  ...
  form.addEventListener('submit', async (event) => {
    ...
    try {
      const response = await fetch('https://hag-ai-prochat.onrender.com/send', {
        method: 'POST',
        body: formData,
